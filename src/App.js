  ...
  return (
    <ThemeProvider theme={original}>
      ...
      >
        ...
        <div className="absolute bottom-5 right-5 flex items-center z-[50]">
          <a href="https://x.com/" className="transition ease-in-out duration-150">
            <svg xmlns="http://www.w3.org/2000/svg" className="size-10 md:size-12 md:hover:scale-105 transition ease-in-out duration-150 cursor-pointer" fill="#000000" viewBox="0 0 50 50">
              <path d="M 6.9199219 6 L 21.136719 26.726562 L 6.2285156 44 L 9.40625 44 L 22.544922 28.777344 L 32.986328 44 L 43 44 L 28.123047 22.3125 L 42.203125 6 L 39.027344 6 L 26.716797 20.261719 L 16.933594 6 L 6.9199219 6 z"></path>
            </svg>
          </a>
          <a href="https://t.me/" className="transition ease-in-out duration-150">
            <svg xmlns="http://www.w3.org/2000/svg" className="size-10 md:size-12  md:hover:scale-105 transition ease-in-out duration-150 cursor-pointer" fill="#00aaff" viewBox="0 0 50 50">
